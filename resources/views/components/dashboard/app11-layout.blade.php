...
<html
  ...
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('build/assets/assets/vendor/css/rtl/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('build/assets/assets/vendor/css/rtl/theme-default.css')}}" class="template-customizer-theme-css" />
    ...
    <link rel="stylesheet" href="{{ asset('build/assets/assets/vendor/libs/typeahead-js/typeahead.css')}}" />
    <link rel="stylesheet" href="{{ asset('build/assets/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
    ...
    <script src="{{ asset('build/assets/assets/vendor/js/template-customizer.js')}}"></script>
                  ...
                  <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                      <div class="avatar avatar-online">
                        <img src="{{ asset('build/assets/assets/img/avatars/1.png')}}" alt class="rounded-circle" />
                      </div>
                    </a>
 ...
 {{ $slot }}
    ...
    <script src="{{ asset('build/assets/assets/vendor/libs/i18n/i18n.js')}}"></script>
    <script src="{{ asset('build/assets/assets/vendor/libs/typeahead-js/typeahead.js')}}"></script>
    <script src="{{ asset('build/assets/assets/vendor/js/menu.js')}}"></script>

    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{ asset('build/assets/assets/vendor/libs/apex-charts/apexcharts.js')}}"></script>
